                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    <div class="h4 text-primary">{{ $user->cards->count() }}</div>
                                    <div class="text-muted">Cards Created</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center">
                                    <div class="h4 text-info">{{ $user->created_at->format('M d, Y') }}</div>
                                    <div class="text-muted">Member Since</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center">
                                    <div class="h4 text-{{ $user->is_active ? 'success' : 'warning' }}">
